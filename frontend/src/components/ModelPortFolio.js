...
const ModelPortfolioPage = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      await axiosInstance.post("/atlip/upload-model/", formData, {
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await axiosInstance.get("/atlip/download-model-template/", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const formDataToSend = {
            ...
            group_email : formData.agent_email, 
